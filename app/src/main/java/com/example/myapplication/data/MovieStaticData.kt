...
fun favoriteMovies():List<Movie>{
    return listOf(
        ...
        "14.11.2001","https://www.imdb.com/title/tt0241527/","fantasy",null),
        ...
        "24.11.2021","https://www.imdb.com/title/tt11214590/","drama",null),
        ...
        "16.11.1990","https://www.imdb.com/title/tt0099785/", "comedy",null),
        ...
        "3.9.2021","https://www.imdb.com/title/tt1160419/","action",null),
        Movie(8, "My girl", "A young girl, on the threshold of her teen years, finds her life turning upside down, when she is accompanied by an unlikely friend.","" +
                "27.11.1991", "https://www.imdb.com/title/tt0102492/","family",null),
        ...
        "21.11.2008", "https://www.imdb.com/title/tt1099212/","fantasy",null),
        ...
        "1.12.2021", "https://www.imdb.com/title/tt14577742/","comedy",null)
    )
         }
...
fun recentMovies():List<Movie>{
    return listOf(
        Movie(11,"Bridget Jones's Diary","Bridget Jones is determined to improve herself while she looks for love in a year in which she keeps a personal diary.","13.4.2001","https://www.imdb.com/title/tt0243155/","comedy",null),
        Movie(12,"The Devil Wears Prada","A smart but sensible new graduate lands a job as an assistant to Miranda Priestly, the demanding editor-in-chief of a high fashion magazine.","30.6.2006","https://www.imdb.com/title/tt0458352/","drama",null),
        Movie(13,"The fast and furious", "Los Angeles police officer Brian O'Conner must decide where his loyalty really lies when he becomes enamored with the street racing world he has been sent undercover to destroy.","https://www.imdb.com/title/tt0232500/","22.6.2001", "thriller",null)
    )
}
